...
const Cart = () => {
  ...
  return (
    <div className="container my-5 mx-auto px-5">
      ...
      <div className="flex flex-wrap-reverse gap-5 md:gap-0 mt-5">
        <CartSummary />
      ...
      <Link
        className='bg-orange-500 inline-block text-white mt-2 px-6 py-2 w-full md:w-fit rounded-lg text-center'
        to={"/order"}
      >
        PROCESS TO CHECKOUT
      </Link>
